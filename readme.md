Here's the README.md content in markdown format for your Flask console program:
...
"database initialized" after successful initialization.
2. Get Competitions
Command:
...
Prints the list of competitions, or "No Competitions" if there are none.
